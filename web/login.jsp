        ...
        <div id="maket">
            ...
            <div id="center"><br>
                ...
                <c:if test="${empty admin && empty client}">
                    <form action="Controller" method="post">
                        <p>Логин:<input type="text" name="login" value="" pattern="^[a-zA-Z][a-zA-Z0-9]{1,20}$" required=""/></p>
                        <p>Пароль:<input type="password" name="password" value="" pattern="^[a-zA-Z0-9]{4,45}$" required=""/></p>
